...
d_i = float(input('Insira a posicao inicial: '))
d_f = float(input('Insira a posicao final: '))
t = float(input('Insira o tempo: '))
a = float(input('Insira a aceleracao do objeto: '))
h = float(input('Insira a altura de queda: '))

print("Velocidade media do objeto")
